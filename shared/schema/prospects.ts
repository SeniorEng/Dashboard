...
export const insertProspectSchema = createInsertSchema(prospects).omit({
  ...
  nr: z.string().max(20).optional().nullable(),
  ...
  statusNotiz: z.string().max(1000).optional().nullable(),
  quelle: z.string().max(200).optional().nullable(),
  quelleDetails: z.string().max(500).optional().nullable(),
...
export const insertProspectNoteSchema = createInsertSchema(prospectNotes).omit({
  ...
  noteText: z.string().min(1, "Notiz darf nicht leer sein").max(2000),
