import { pgTable, text, integer, numeric, serial, time, date, boolean, unique, index } from "drizzle-orm/pg-core";
import { z } from "zod";
...
export const employeeTimeEntries = pgTable("employee_time_entries", {
  ...
  kilometers: numeric("kilometers", { precision: 10, scale: 3, mode: "number" }).default(0),
