...
export const insuranceProviders = pgTable("insurance_providers", {
  ...
  fax: text("fax"),
  email: text("email"),
  emailVerhinderungspflege: text("email_verhinderungspflege"),
  kimAdresse: text("kim_adresse"),
  ansprechpartner: text("ansprechpartner"),
  datenannahmeIk: text("datenannahme_ik"),
...
export const insertInsuranceProviderSchema = z.object({
  ...
  emailVerhinderungspflege: internationalEmailSchema.optional().nullable(),
