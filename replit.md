...
- **Statistics Page (`/admin/statistics`)**: Redesigned from 7 tabs to 4 consolidated tabs:
  ...
  - **Kunden**: Kundenstatus-Karten (aktiv/inaktiv/gewonnen/verloren), Pflegegradverteilung, §45b Budget, Leistungsstunden-Donut, Kunden-Lifecycle-Chart. Merged aus alten Tabs "Kunden" + "Wachstum".
