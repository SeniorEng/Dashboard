...
| **C** | Stammdaten und Historie weichen heute ab | Die Steuer liest nur die Historie; C ist ein Datenfehler der Anzeige. Einzeln prüfen, über „Pflegegrad ändern" korrigieren. |
