...
import { Calendar, Plus, Car, Users, Pencil, Trash2, Bot } from "lucide-react";
                    ...
                    <div>
                      <div className={`font-medium ${config.color} flex items-center gap-2`}>
                        ...
                        {entry.isAutoGenerated && (
                          <Badge variant="outline" className="text-xs bg-blue-50 text-blue-600 border-blue-200 py-0 px-1.5" data-testid={`badge-auto-break-${entry.id}`}>
