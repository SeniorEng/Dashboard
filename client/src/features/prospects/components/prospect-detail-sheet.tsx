...
import {
  Phone, Mail, MapPin, UserPlus, Clock, MessageSquare, PhoneCall, Trash2,
  CalendarClock, XCircle, ArrowRightCircle, Loader2, RefreshCw, CheckCircle2,
  ShieldCheck, FileText, Ban, Pencil, Check, X, Plus,
} from "lucide-react";
import {
  useProspect, useUpdateProspect, useAddProspectNote, useReparseProspect,
  useDeleteProspect, useQualifyProspect, useProspectOffer,
...
import {
  PROSPECT_NOTE_TYPE_LABELS, DISQUALIFICATION_REASON_LABELS, DISQUALIFICATION_REASONS,
...
import { NOTE_TYPE_ICONS } from "./prospect-status-constants";

export function ProspectDetailSheet({ prospectId, open, onClose }: { prospectId: number | null; open: boolean; onClose: () => void }) {
