...
/**
 * @deprecated Task #728 (Phase 2.1): Tabelle `customer_budgets` ist als
 * Read-Quelle abgeschaltet (SSoT = `customer_budget_type_settings`).
 * Diese Funktionen bleiben ausschließlich für historische Audit-Reads
 * bestehen, bis die Tabelle in einer späteren Phase entfernt wird. KEINE
 * neuen Aufrufer — der Architektur-Test
 * `tests/architecture/no-customer-budgets-reads.test.ts` blockt das.
 */
...
/** @deprecated siehe oben — Read-Only-Historie aus eingefrorener Tabelle. */
